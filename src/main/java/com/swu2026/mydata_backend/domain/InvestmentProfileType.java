...
public enum InvestmentProfileType {
    ...
    // 투자성향 점수 카드의 5개 세부 항목 %. 응답별로 계산하는 값이 아니라 유형(등급)별로 고정된 값.
    private final double investmentExperiencePercent;
    private final double lossTolerancePercent;
    private final double investmentPeriodPercent;
    private final double profitSeekingPercent;
    private final double incomeStabilityPercent;
    ...
    InvestmentProfileType(
        ...
        double investmentExperiencePercent, double lossTolerancePercent, double investmentPeriodPercent,
        double profitSeekingPercent, double incomeStabilityPercent
    ) {
        ...
        this.investmentExperiencePercent = investmentExperiencePercent;
        this.lossTolerancePercent = lossTolerancePercent;
        this.investmentPeriodPercent = investmentPeriodPercent;
        this.profitSeekingPercent = profitSeekingPercent;
        this.incomeStabilityPercent = incomeStabilityPercent;
    }
